...
<body>
    <?php
        ...
        $userInfo = _get_user_information($_GET['user_id']);
        $day_used = _get_day_off_used($_GET['user_id']);
    ?>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="staticBackdropLabel">Xác nhận đặt lại mật khẩu nhân viên</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                <div class="modal-body">
                    Bạn có chắc là muốn đặt lại mật khẩu mặc định cho nhân viên <b><?php echo $userInfo['user_name'] ?></b> chứ?
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-secondary" data-dismiss="modal">Hủy</button>
                    <button type="button" class="btn btn-primary user-edit-btn" value="<?php echo $userInfo['user_id'] ?>" id="btn-reset-user-pass">Xác nhận</button>
                </div>
            </div>
        </div>
    </div>
    <div class="body-layout">
        <div class="container">
            <div class="row rounded bg-white mt-5 user-detail">
                ...
                <div class="col-md-8">
                    <div class="p-3 py-5">
                        <div class="d-flex justify-content-between align-items-center mb-3">
                            ...
                            <h6 class="text-right primary-text user-edit-btn" id="edit-mode-btn" value="<?php echo $userInfo['user_id'] ?>">Cập nhật thông tin &nbsp; <i class="fas fa-user-edit"></i></h6>
                        </div>
                        ...
                        <form class="user-detail-form" id="user_update_form">
                            <?php
                                if(isset($_GET["status"])){
                                    if($_GET["status"] == "updated")
                                    echo '<div class="alert alert-info"> Cập nhật thông tin nhân viên thành công </div>';
                                }
                            ?>
                            <div class="alert alert-info" id="message_update_user_infor"> Cập nhật thông tin nhân viên thành công </div>
